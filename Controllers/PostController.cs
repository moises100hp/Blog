...
namespace Blog.Controllers
{
    ...
    public class PostController : ControllerBase
    {
            ...
            [FromRoute] int id)
        {
            ...
            {
                return StatusCode(500, new ResultViewModel<Post>("05X06 - Falha interna do servidor."));
            }
        }
            ...
            [FromQuery] int pageSize = 25)
        {
            ...
            {
                return StatusCode(500, new ResultViewModel<List<Post>>("05X07 - Falha interna do servidor."));
            }
        }
    }
}
